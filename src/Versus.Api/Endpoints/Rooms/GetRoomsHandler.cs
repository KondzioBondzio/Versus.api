...
public class GetRoomsHandler : IEndpoint
{
    ...
    public static async Task<Results<Ok<PagedResponse<GetRoomsResponse>>, ProblemHttpResult, UnauthorizedHttpResult>>
        HandleAsync([AsParameters] GetRoomsRequest request,
    ...
    private static Expression<Func<Room, GetRoomsResponse>> ProjectTo => src => new GetRoomsResponse
    {
        ...
        OccupiedSlots = src.Teams.Select(t => t.Users.Count).Count(),
