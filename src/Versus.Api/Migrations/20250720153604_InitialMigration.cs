        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FeatureFilters_Features_FeatureId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamPlayerLimit = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "FeatureFilterParameters",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Value = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    FeatureFilterId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeatureFilterParameters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FeatureFilterParameters_FeatureFilters_FeatureFilterId",
                        column: x => x.FeatureFilterId,
                        principalTable: "FeatureFilters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomChatMessages_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeatureFilterParameters_FeatureFilterId",
                table: "FeatureFilterParameters",
                column: "FeatureFilterId");

            migrationBuilder.CreateIndex(
                name: "IX_FeatureFilters_FeatureId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomChatMessages_UserId",
                table: "RoomChatMessages",
                column: "UserId");
